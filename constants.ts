...
export const SQUARE_APP_ID = import.meta.env.VITE_SQUARE_APP_ID || 'sandbox-sq0idb-YOUR_APP_ID_HERE';
export const SQUARE_LOCATION_ID = import.meta.env.VITE_SQUARE_LOCATION_ID || 'YOUR_LOCATION_ID_HERE';
...
export const GAMES_DATA: Game[] = [
  ...
  { id: 3, title: "Holybots Arena", category: "Shooter", rating: "T", image: "https://placehold.co/600x900/333/fff?text=HOLYBOTS", desc: "High-octane PvP action! Pilot service robots turned battle machines in a chaotic free-for-all." },
  ...
  { id: 5, title: "Gang Of Dummizz", category: "Shooter", rating: "T", image: "https://placehold.co/600x900/333/fff?text=GANG%20OF%20DUMMIZZ", desc: "A hilarious shooter where you battle hordes of clumsy, colorful dummies." },
  { id: 6, title: "Cops vs Robbers", category: "Shooter", rating: "T", image: "https://placehold.co/600x900/333/fff?text=COPS%20VS%20ROBBERS", desc: "Team-based PvP shooter: join the police or the criminals and fight for control." },
  { id: 7, title: "Overrun", category: "Shooter", rating: "M", image: "https://placehold.co/600x900/333/fff?text=OVERRUN", desc: "A fast-paced survival shooter. Defend your position against endless waves of enemies." },
  { id: 8, title: "RevolVR 3", category: "Shooter", rating: "T", image: "https://placehold.co/600x900/333/fff?text=REVOLVR%203", desc: "Wild West-themed multiplayer shooter. Duel opponents in fast-paced competitive matches." },
